...
export default function PurchaseSheet({ open, onOpenChange, defaultCardId = null }) {
    if (!open) return null;
            ...
            <div className="relative w-full max-w-lg rounded-t-3xl sm:rounded-2xl bg-white p-6 shadow-xl z-10 max-h-[90vh] overflow-y-auto">
                ...
                <div className="mb-4 flex items-center justify-between border-b pb-3">
                    <h2 className="text-xl font-bold text-slate-900">
                        🛍️ Registrar Compra con Tarjeta
                    </h2>
                ...
                <CardPurchaseForm defaultCardId={defaultCardId} onSuccess={handleClose} />
            </div>
        </div>
    );
}
